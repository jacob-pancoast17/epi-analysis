---
title: "Temporal Trends in RSV Wastewater Concentrations Across Vermont Monitoring Sites, 2023-2026"
date: "May 23, 2026"
...
RSV epidemiology in the United States indicate RSV trends increase in the fall (respiratory virus season) in the United States, peaking in the winter (December or January) before case numbers lower as spring approaches^1^. This year the CDC identified a temporal shift in the 25-26 season. RSV activity started later in most parts of the US, and also peaked later^2^.
...
``` {r flu_burden, fig.align = "center", fig.caption = "Figure 1. Estimated ranges of annual flu and RSV burdens.\n Flu burdens are estimated using data from 2010-2025 obtained from https://www.cdc.gov/flu-burden/php/about/index.html.\n RSV burdens are estimated from a 2023 CDC MMWR report from https://doi.org/10.1016/j.ajt.2023.09.003"}

flu_rsv_burdens <- 
  (
    ggdraw() +
      draw_image("figures/flu-burden.png") +
      draw_label(label = "Flu Burden", x = 0.5, y = 0.95)
    ) +
  ...
  (
    ggdraw() +
     draw_image("figures/rsv-burden.png") +
      draw_label(label = "RSV Burden", x = 0.5, y = 0.95)
    ) +
...
The hospitalization rate for RSV may be between 2 - 4.4 times lower than influenza, while the mortality rate may be between 1.05 - 5.2 times lower than influenza (Figure 1).
...
``` {r NREVSS_dash, fig.align = "center", fig.cap = "Figure 2. The CDC NREVSS Dashboard of the week ending April 25, 2026 obtained from https://www.cdc.gov/nrevss/php/dashboard/index.html"}
...
``` {r NWSS_sites, fig.align = "center", fig.cap = "Figure 3. United States NWSS Sites reporting RSV concentrations as of May 14, 2025 obtained from https://www.cdc.gov/wastewater/about/index.html?cove-tab=3"}
...
2. Centers for Disease Control and Prevention. About RSV. https://www.cdc.gov/respiratory-viruses/data/. Updated May 20, 2026. Accessed May 21, 2026.

3. Davido B, Loubet P. The silent surge: The under-recognised burden of respiratory syncytial virus, human metapneumovirus, and Parainfluenza viruses in adults. International Journal of Infectious Diseases. 2025;159:108006. doi:10.1016/j.ijid.2025.108006 
